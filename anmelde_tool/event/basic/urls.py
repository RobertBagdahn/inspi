...
urlpatterns = [
    ...
    path(
        "detail/<slug:slug>/overview",
        views.event_detail_overview,
    ...
    path(
        "event-wizard/", views.EventWizardView.as_view(form_list), name="event-wizard"
    ),
    path(
    ...
    path(
        "detail/module/<int:pk>", views.event_module_detail, name="event-module-detail"
    ),
    path(
    ...
    path(
        "detail/module/<int:pk>/attribute/select-create",
        views.event_module_attribute_select_create,
        name="event-module-attribute-select-create",
    ),
    path(
        "detail/module/<int:pk>/attribute/select-create-set",
        views.event_module_attribute_select_create_set,
        name="event-module-attribute-create-set",
    ),
    path(
